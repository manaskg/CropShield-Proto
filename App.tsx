...
export type Page = 'home' | 'detect' | 'soil' | 'smart-farm' | 'login' | 'signup' | 'profile';
...
function AppContent() {
  ...
  const renderPage = () => {
    switch(page) {
      case 'detect': return <Detect onNavigate={setPage} />;
      case 'soil': return <SoilLab />;
      case 'smart-farm': return <SmartFarm />;
