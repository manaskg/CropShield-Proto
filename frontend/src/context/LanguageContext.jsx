...
const translations = {
  en: {
    ...
    "result.days": "days",
    "result.cause_title": "Cause of Disease",
    "result.prev_title": "Preventive Measures",
    "auth.join": "Join Us",
    ...
    "expert.vol.spec": "Specialization",
    "expert.vol.id": "Upload Student ID",
  ...
  hi: {
    ...
    "result.days": "दिन",
    "result.cause_title": "बीमारी का कारण",
    "result.prev_title": "बचाव के उपाय",
    "auth.join": "जुड़ें",
    ...
    "expert.title": "किसान सहायक नेटवर्क",
    "expert.subtitle": "विशेषज्ञों से जुड़ें या स्वयंसेवक बनें।",
    "expert.tab.find": "विशेषज्ञ खोजें",
    "expert.tab.volunteer": "स्वयंसेवक बनें",
    "expert.btn.profile": "प्रोफाइल देखें",
    ...
    "expert.vol.spec": "विशेषज्ञता",
    "expert.vol.id": "छात्र आईडी अपलोड करें",
  ...
  bn: {
    ...
    "result.days": "দিন",
    "result.cause_title": "রোগের কারণ",
    "result.prev_title": "প্রতিরোধ ব্যবস্থা",
    "auth.join": "যোগ দিন",
    ...
    "expert.title": "কিষাণ সহায়ক নেটওয়ার্ক",
    "expert.subtitle": "বিশেষজ্ঞদের সাথে সংযোগ করুন বা স্বেচ্ছাসেবক হন।",
    "expert.tab.find": "বিশেষজ্ঞ খুঁজুন",
    "expert.tab.volunteer": "স্বেচ্ছাসেবক হন",
    "expert.btn.profile": "প্রোফাইল দেখুন",
    ...
    "expert.vol.spec": "বিশেষীকরণ",
    "expert.vol.id": "ছাত্র আইডি আপলোড করুন",
