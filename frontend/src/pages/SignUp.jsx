        ...
        <div className="p-8">
          {error && (
            <div className="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg flex items-start gap-3">
              <AlertCircle className="text-red-500 mt-0.5 w-5 h-5 shrink-0" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  <Ruler className="absolute left-3 top-3.5 text-stone-400 w-5 h-5" />
                  <input
                    type="number"
                    name="farmSize"
                ...
                <div className="relative">
                  <Wheat className="absolute left-3 top-3.5 text-stone-400 w-5 h-5" />
                  <input
                    type="text"
                    name="primaryCrops"
