...
import { Sprout, ShieldCheck, ArrowRight, CloudSun, CheckCircle2, PlayCircle, Languages, WifiOff, IndianRupee, ShoppingBag, Star, MessageCircle, ChevronDown } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center justify-center text-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 justify-center pt-4">
              ...
              <button onClick={() => onNavigate('detect')} className="group px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-medium rounded-full backdrop-blur-sm border border-white/20 transition-all flex items-center gap-3 hover:border-white/40">
